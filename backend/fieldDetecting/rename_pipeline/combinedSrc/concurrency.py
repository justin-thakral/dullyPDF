"""
Threading helpers for per-page and batch processing.

We expose a small API to keep worker counts configurable and results ordered.
"""
...
def _int_from_env(name: str, default: int) -> int:
    """
    Parse a positive integer from an env var with a fallback.
    """
    raw = os.getenv(name)
    if raw is None:
        return default
