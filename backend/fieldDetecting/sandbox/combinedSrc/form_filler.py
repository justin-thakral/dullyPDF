...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output PDF path (defaults to backend/fieldDetecting/forms/native/temp<first5><last5>.pdf)",
    )
    ...
    if output is None:
        ...
        output = Path("backend/fieldDetecting/forms/native") / f"{prefix}.pdf"
