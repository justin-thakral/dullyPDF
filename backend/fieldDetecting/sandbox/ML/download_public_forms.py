...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to sources.csv (defaults to <repo>/backend/fieldDetecting/sandbox/ML/data/raw/sources.csv).",
    )
    parser.add_argument(
        "--max-bytes",
        type=int,
    ...
    out_root = repo_root / "backend" / "fieldDetecting" / "sandbox" / "ML" / "data" / "raw"
