...
def main() -> None:
    ...
    parser.add_argument(
        "--hipaa",
        type=Path,
        default=Path("backend/sandbox/pdfs/native/HIPPA.pdf"),
        help="Path to the HIPAA release PDF.",
    )
    parser.add_argument(
        "--medical-history",
        type=Path,
        default=Path("backend/sandbox/pdfs/scanned/medical-history-intake-form.pdf"),
        help="Path to the medical history intake PDF.",
    )
    parser.add_argument(
        "--patient-intake",
        type=Path,
        default=Path("backend/sandbox/pdfs/native/patient-Intake-pdf.pdf"),
    ...
    parser.add_argument(
        "--out-root",
        type=Path,
        default=Path("backend/sandbox/outputArtifacts"),
