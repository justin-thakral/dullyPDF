...
OPENAI_RENAME_TASKS_LOCATION="${OPENAI_RENAME_TASKS_LOCATION:-${DETECTOR_TASKS_LOCATION:-us-east4}}"
...
OPENAI_REMAP_TASKS_LOCATION="${OPENAI_REMAP_TASKS_LOCATION:-${DETECTOR_TASKS_LOCATION:-us-east4}}"
