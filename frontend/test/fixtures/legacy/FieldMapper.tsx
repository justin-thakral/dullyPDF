/**
 * UI for uploading database fields and applying AI mappings.
 */
import React, { useState, useRef } from 'react';
import { ApiService } from '../../../src/services/api';
import { CONFIDENCE_THRESHOLDS, parseConfidence } from '../../../src/utils/confidence';
import './FieldMapper.css';

const DEBUG_FIELD_MAPPER = false;
/**
 * Conditional logger for mapping workflow diagnostics.
 */
...
/**
 * Estimate mapping confidence based on normalized name similarity.
 */
...
/**
 * Render the mapping upload flow and apply renames.
 */
const FieldMapper: React.FC<FieldMapperProps> = ({
  ...
  /**
   * Upload the database field list text file.
   */
  ...
  /**
   * Request AI field mappings from the backend.
   */
  ...
  /**
   * Apply a single mapping to rename a field in the editor.
   */
  ...
  /**
   * Reset upload/mapping state and clear the file input.
   */
  const reset = () => {
    setUploadState({
      isUploading: false,
  ...
  /**
   * Map confidence scores to a color bucket.
   */
